...
class IO(Commands):
    ...
    @staticmethod
    def save_compressed_frame_player_animation(toy, s, s2, z, s3, s_arr, i, i_arr, proc=None):  # Untested / Unknown Param Names
    ...
    compressed_frame_player_animation_complete_notify = (26, 60, 0xff), lambda listener, p: listener(p.data[0])  # Untested / Unknown Param Names
